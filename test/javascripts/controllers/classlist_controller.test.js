...
const html = '<div id="element" class="bar" data-controller="classlist" data-classlist-toggle-class="foo"></div>'
...
suite('classlist controller', () => {
  ...
  test('Add css class "foo"', async () => {
    ...
    const target = '<template data-classlist-target="dummy"></template>'
